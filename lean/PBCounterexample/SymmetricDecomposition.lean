...
/-! Degree-two polynomial decomposition in symmetric matrix coordinates. -/

namespace PBCounterexample.SymmetricDecomposition

open PBCounterexample.SymmetricFunction
...
theorem matrix_polynomial_decomposition (p : MvPolynomial Coord ℝ)
  ...
  obtain ⟨c, L, Q, hsym, hrep⟩ := QuadraticDecomposition.polynomial_representation p hp
...
end PBCounterexample.SymmetricDecomposition
