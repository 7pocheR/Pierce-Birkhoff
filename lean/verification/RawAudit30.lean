...
run_cmd do
  ...
  unless roots.contains ``PBCounterexample.SymmetricMain.pierce_birkhoff_counterexample30 do
    throwError "The final counterexample theorem was not included in the enumerated declarations"
  for required in #[``PBCounterexample.Collaborator30Main.pierce_birkhoff_counterexample30,
      ``PBCounterexample.Collaborator30Main.explicit_quadratic_counterexample30,
      ``PBCounterexample.Collaborator30Main.no_finite_max_min_representation] do
    unless roots.contains required do throwError "Missing required final root {required}"
  ...
  for name in #[``PBCounterexample.SymmetricMain.pierce_birkhoff_counterexample30,
